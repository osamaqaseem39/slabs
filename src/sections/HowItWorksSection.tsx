    ...
    >
      <div className="container mx-auto px-6 md:px-10 lg:px-14">
        <div className="max-w-3xl space-y-6 mb-20">
          <p className="mb-4 text-sm uppercase tracking-[0.4em] text-[#00BDFF]">
            How It Works
          </p>
        ...
        <div className="mb-16 relative">
          <div className="flex items-center justify-between max-w-4xl mx-auto px-4 relative">
            ...
            <div className="absolute top-4 left-0 right-0 h-0.5 z-0 overflow-hidden" style={{ left: '2rem', right: '2rem' }}>
              <motion.div 
                className="h-full bg-[#00BDFF] origin-left"
                ...
                <div className="flex flex-col items-center gap-3">
                  <motion.div
                    className={`h-8 w-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 relative z-[11] ${
                      currentIndex === index
                        ? "bg-[#00BDFF] text-white shadow-lg shadow-[#00BDFF]/50 scale-110"
                        : currentIndex > index
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <button
            onClick={handlePrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-white/[0.05] border border-white/10 hover:border-[#00BDFF]/50 hover:bg-[#00BDFF]/10 transition-all duration-300 group"
          ...
          >
            <svg
              ...
              className="text-white/60 group-hover:text-[#00BDFF] transition-colors"
            >
          ...
          <button
            onClick={handleNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 z-10 flex items-center justify-center w-12 h-12 rounded-full bg-white/[0.05] border border-white/10 hover:border-[#00BDFF]/50 hover:bg-[#00BDFF]/10 transition-all duration-300 group"
          ...
          <div className="relative h-[480px] overflow-hidden">
            <AnimatePresence mode="wait">
              ...
              >
                <motion.article
                  className="group relative flex h-[460px] w-full max-w-[800px] md:max-w-[900px] lg:max-w-[1000px] flex-col overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.05] to-white/[0.02] backdrop-blur-sm transition-all duration-300 hover:border-[#00BDFF]/30 perspective-[1600px] cursor-pointer"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex h-full flex-col p-10 md:p-12 [backface-visibility:hidden]">
                      <div className="flex items-start justify-between mb-8">
                        <div className="flex items-center gap-5">
                          <div className="flex h-16 w-16 md:h-20 md:w-20 items-center justify-center rounded-xl bg-[#00BDFF]/10 text-4xl md:text-5xl">
                            {PROCESS_STEPS[currentIndex].icon}
                          </div>
                          <div className="text-sm font-medium text-[#00BDFF]">
                      ...
                      <div className="flex-1 space-y-5">
                        ...
                        <p className="text-base md:text-lg font-medium text-[#00BDFF]/80 uppercase tracking-wider">
                    ...
                    <div className="absolute inset-0 flex h-full flex-col p-8 bg-gradient-to-br from-[#020617] to-[#0a1628] [backface-visibility:hidden] [transform:rotateY(180deg)] overflow-hidden">
                      <div className="mb-4 flex-shrink-0">
                        <div className="text-sm font-medium text-[#00BDFF] mb-2 uppercase tracking-wider">
                          {PROCESS_STEPS[currentIndex].timeline}
                        </div>
                      ...
                      <div className="flex-1 grid grid-cols-2 gap-6 min-h-0">
                        ...
                        <div className="flex flex-col min-h-0">
                          <div className="text-xs font-semibold text-[#00BDFF]/80 mb-3 uppercase tracking-wider">
                            Deliverables
                          </div>
                          <div className="space-y-2.5 flex-1">
                            {PROCESS_STEPS[currentIndex].deliverables.map((item, idx) => (
                              ...
                              >
                                <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#00BDFF]/20">
                                  <svg className="h-4 w-4 text-[#00BDFF]" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="flex flex-col space-y-4 min-h-0">
                          ...
                          <div className="flex-shrink-0">
                            <div className="text-xs font-semibold text-[#00BDFF]/80 mb-2 uppercase tracking-wider">
                              Key Activities
                            </div>
                          ...
                          <div className="pt-3 border-t border-white/10 flex-shrink-0">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {Object.entries(PROCESS_STEPS[currentIndex].stats).map(([key, value], idx) => (
                                ...
                                >
                                  <div className="text-base font-bold text-[#00BDFF] mb-0.5">
                                    {value}
                                  </div>
            ...
            {PROCESS_STEPS.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  currentIndex === index
                    ? "w-10 bg-[#00BDFF] shadow-[0_0_12px_rgba(0,189,255,0.5)]"
